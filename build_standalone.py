    ...
    <div id="content-container" class="flex-1 flex flex-col min-w-0 bg-slate-900 z-10 shadow-[-10px_0_15px_-3px_rgba(0,0,0,0.5)] h-[60vh] md:h-screen overflow-hidden">
        ...
        <div class="p-3 md:p-6 pb-0 flex-shrink-0 bg-slate-900 z-20">
            <div class="flex justify-between items-center w-full">
                <div>
                    <h1 class="text-xl sm:text-2xl md:text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-lime-400 to-cyan-400 mb-0.5">Wyrypa 100km Ultra-Trekking <span style="font-size: 0.5em; color: white;">v1.5</span></h1>
